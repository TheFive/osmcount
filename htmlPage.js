...
HtmlPage.prototype = {
  ...
  /*  if (typeof (this.menu) != 'undefined' && this.menu != "") {
    ...
    var odblLicense = 'OSMCount Version 0.3. Daten von <a href="http://www.openstreetmap.org/">OpenStreetMap</a> - Veröffentlicht unter <a href="http://opendatacommons.org/licenses/odbl/">ODbL</a>';
